...
# Renombrar el archivo como "Casen_2022"

# Establecer directory de trabajo (cambiar a la ubicación en computador donde guardaron la base de datos)

getwd()
setwd("/Users/Mauricio/......")

# Importar datos Casen 2022 desde formato .sav (SPSS). Requiere paquete "foreign" para leer archivos .sav
...
?foreign
??foreign
data_casen <-  read.spss("Casen_2022.sav", to.data.frame=TRUE)
?read.spss
