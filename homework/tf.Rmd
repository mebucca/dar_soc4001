...
3) Desde el repositorio del curso descargar la base de datos que da cuenta del número de casos fallecidos por cada mil habitantes en cada una de las comunas de Chile según su residencia. Puedes usar el siguiente código para importar los datos a `R`:
...
7) Produce el siguiente reporte: [Link](https://github.com/mebucca/dar_soc4001/blob/master/homework/tf_reporte.docx)
